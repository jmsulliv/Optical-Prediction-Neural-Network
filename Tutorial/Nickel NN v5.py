...
if AR_Filter == 'Yes':
    ...
    data = loadmat('Data/Normalized AR Data for FDTD Simulations (36000 Starting Points)- 20210706.mat',
                   squeeze_me=True,
                   struct_as_record=False)
...
# Unseen Grid Data Predict with timing function
unseenmats = loadmat('Unseen GridData/Unseen GridData (41 Unseen Materials)- 20210706.mat',
                   squeeze_me=True,
                   struct_as_record=False)
Unseen_MatGrid = unseenmats['GridData']
Unseen_Coords = unseenmats['GridCoords']
Unseen_MatGrid = Unseen_MatGrid.T
...
filename_unseen = 'Prediction Data\model_V2_Ni%dFD_UnseenGrid_Prediction.mat' % Iter_number
...
UnseenSims = loadmat('Data/Unseen FDTD Sims (25 Unseen Materials)- 20210706.mat',
                   squeeze_me=True,
                   struct_as_record=False)
Multi_Input = UnseenSims['Multi_Input']
Multi_Output = UnseenSims['Multi_Output']

Multi_Input = Multi_Input.T
Multi_Output = Multi_Output.T

Unseen_Sim_Pred = model.predict(Multi_Input, verbose=0)
unseen_loss, unseen_acc = model.evaluate(Multi_Input, Multi_Output, verbose=0)
...
filename_unseen = 'Prediction Data\model_V2_Ni%dFD_UnseenFDTD_Prediction.mat' % Iter_number
savemat(filename_unseen, mat_ids)
