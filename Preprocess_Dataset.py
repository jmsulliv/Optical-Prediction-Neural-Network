...
'''kDataOut = power_transformer.fit_transform(kdata)'''
...
'''eimDataOut = power_transformer.fit_transform(eimdata)'''
...
'''ROut = power_transformer.fit_transform(Rdata)'''
...
'''TOut = power_transformer.fit_transform(Tdata)'''
...
# Section 2 -- use already fit data to Fit to new datasets
